...
const Home = () => {
  ...
  return (
    <div className="bg-white text-black min-h-screen">
      ...
      <header className="text-center py-10 bg-gradient-to-r from-blue-500 to-yellow-400 text-white">
        <h1 className="text-4xl font-bold">
          Платформа онлайн-курсів з психології
        </h1>
        <p className="mt-4 text-lg">
          Навчайтеся в зручному темпі, отримуйте практичні навички та рухайтеся
          до психологічного добробуту разом із нами!
        </p>
      </header>
